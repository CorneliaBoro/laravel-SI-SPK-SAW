...
@section('header')
    <div class="row mb-2 mx-2 justify-content-between">
        <div class="col-sm-5">
            <h5>Data Asisten Laboratorium</h5>
        </div>
        <div class="col-sm-6">
...
@section('konten')
    ...
    <form action="{{ route('dataaslab.update', $data->id) }}" method="POST">
        @csrf
        @method('put')
        <div class="mb-3">
            <label for="nim" class="form-label">NIM</label>
            <input type="text" class="form-control form-control-sm" name="nim" id="nim" placeholder=""
                value="{{ $data->nim }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-sm" name="ipk" id="ipk" placeholder=""
                value="{{ $data->ipk }}">
        </div>
